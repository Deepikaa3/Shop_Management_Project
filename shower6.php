...
$sql = "SELECT
    ...
    if ($result->num_rows > 0) {
     ...
     // $totalBalance = $tbalance-$totalamount;
  } else {
      $totalUsers = 0;
      //$tbalance = 0;
      $tamount = 0;
...
$sql = "INSERT INTO owneraccounts (username, shopname, umobilenumber, smobilenumber, credit,balance, purchasedate)
        VALUES (
            '$username',
            '$shopname',
            '$umobilenumber',
    ...
    <ul class="list-group">
        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
            <div class="d-flex flex-column">
                ...
                <h6 class='mb-2 text-sm'>Paid Amount: <span class='text-dark ms-sm-2 font-weight-bold'><?= $totalamount ?></span></h6>
                <h6 class='mb-2 text-sm'>Balance Amount: <span class='text-dark ms-sm-2 font-weight-bold'><?= $balance ?></span></h6>
