...
$itemscount = isset($_GET['itemscount']) ? $_GET['itemscount'] : null;
...
$sql1 = "SELECT balance FROM owneraccounts WHERE smobilenumber = '$smobilenumber' AND umobilenumber = '$umobilenumber' ORDER BY id LIMIT 1";
//echo $sql1;
...
$sql = "INSERT INTO owneraccounts (username, shopname, umobilenumber, smobilenumber, totalamount, credit, balance, purchasedate,itemscount,notes)
        VALUES (
            '$username',
            '$shopname',
            '$umobilenumber',
    ...
    <ul class="list-group">
        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
            <div class="d-flex flex-column">
                ...
                <h6 class='mb-2 text-sm'>Bill Amount: <span class='text-dark ms-sm-2 font-weight-bold'><?= $totalamount ?></span></h6>
                <h6 class='mb-2 text-sm'>Amount Paid: <span class='text-dark ms-sm-2 font-weight-bold'><?= $credit ?></span></h6>

                <h6 class='mb-2 text-sm'>Balance Amount: <span class='text-dark ms-sm-2 font-weight-bold'><?= $tamount ?></span></h6>
                <?php
                if (!empty($itemscount)) {
                    echo "<h6 class='text-xs'>Itemscount: <span class='text-dark ms-sm-2 font-weight-bold'>" . $itemscount . "</span></h6>";
                }
                ?>

                <?php
                if (!empty($notes)) {
                    echo "<h6 class='text-xs'>Notes: <span class='text-dark ms-sm-2 font-weight-bold'>" . $notes . "</span></h6>";
                }
                ?>
