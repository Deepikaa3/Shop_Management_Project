...
<body>
  ...
  ?>
   ...
   include 'config.php';
    ...
    $query = "SELECT username,dob, gender, mobilenumber, profession, aaddress , city, district, sstate, pincode FROM usersignup WHERE mobilenumber = '$umobilenumber'";
    $result = $conn->query($query);
     ...
     if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_assoc()) {
        ...
        $sstate = $row["sstate"];
        $pincode = $row["pincode"];   
        $umobilenumber = $row["mobilenumber"];
...
$umobilenumber=$_COOKIE['umobilenumber'];
$user = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM usersignup WHERE mobilenumber = '$umobilenumber'"));
?>
<!DOCTYPE html>
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    if(isset($_FILES["fileImg"]["name"])){
      ...
      $query = "UPDATE usersignup SET images = '$imageName' WHERE mobilenumber = '$umobilenumber'";
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $umobilenumber;?></div>
                  </div>
...
<form action="profile1.php" method="post">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="dob"autocomplete="off" type="date" class="form-control" id="fullName" value="<?php echo $dob;?> " required>
                      </div>
                    </div>
                    <div class="row mb-3">
  ...
  <option value="others">Others</option>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        <label for="Address" class="col-md-4 col-lg-3 col-form-label">Profession</label>
                        <div class="col-md-8 col-lg-9">
                          <input name="profession" autocomplete="off"type="text" class="form-control" id="Address" value="<?php echo $profession;?>"required>
                        </div>
                      </div>
