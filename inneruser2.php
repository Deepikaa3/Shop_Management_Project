...
echo '<form action="inneruseradd2.php?username=' . urlencode($uusername) . '&mobilenumber=' . urlencode($mobilenumber) . '" method="post" onsubmit="return validateForm()">';
?>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" autocomplete="off"type="number" id="totalamount" value="$" name="totalamount">                </div>
                </div>
               <!-- <div class="col-md-6">
                  <div class="form-group">
