...
echo '<form action="inneruseradd.php?username=' . urlencode($uusername) . '&mobilenumber=' . urlencode($mobilenumber) . '" method="post" onsubmit="return validateForm()">';
?>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label text-sm">Bill Amount</label>
                    <input class="form-control" autocomplete="off"type="number" id="totalamount" name="totalamount" required>                </div>
                </div>
                <div class="col-md-6">
                  <!--<div class="form-group">-->
                    
                    <input type="hidden"autocomplete="off" name="username" value="<?php echo htmlspecialchars($uusername); ?>">
 <!-- </div>-->
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    
                    <input type="hidden" autocomplete="off"name="mobilenumber" value="<?php echo htmlspecialchars($mobilenumber); ?>">
  </div>
                </div>
                <div class="col-md-6">
  <div class="form-group">
    <label for="example-text-input" class="form-control-label text-sm">Amount Paid</label>
    <input class="form-control" autocomplete="off"type="number" id="credit" name="credit" required onchange="return calculateBalance();">
  </div>
</div>
...
<div class="col-md-6">
  <div class="form-group">
    ...
    <input class="form-control"autocomplete="off" type="number" id="balance" name="balance" readonly>
  </div>
</div>
<div class="form-group"></div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" autocomplete="off"type="number" id="itemscount" name="itemscount">
                </div>
              </div>
              <div class="form-group"></div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control" autocomplete="off"type="text" id="notes" name="notes">
              </div>
            </div>
            <div class="form-group"></div>
            </div> 
