...
<body>
  ...
  include 'config.php';
    ...
    $query = "SELECT shopname, credit, balance, totalamount, creditdate,purchasedate,smobilenumber FROM owneraccounts WHERE umobilenumber = '$umobilenumber'order by id desc";
...
$sql2 = "SELECT ownersignup.images from ownersignup JOIN owneraccounts ON ownersignup.mobile_number = owneraccounts.smobilenumber WHERE owneraccounts.smobilenumber ='$smobilenumber'";
...
$row1 = $result1->fetch_assoc();?>
  ...
  <?php
   ...
   ?>
    ...
    <td class="text-center"><a href="#" class="text-primary fw-bold"><?php echo $shopname; ?></a></td>
