...
echo '<form action="inneruseradd3.php?username=' . urlencode($uusername) . '&mobilenumber=' . urlencode($mobilenumber) . '" method="post" onsubmit="return validateForm()">';
?>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="number" id="credit" value="$" name="credit" required>                </div>
                </div>
                <div class="col-md-6">
                  <!--<div class="form-group">-->
